...
public class Spike {
    ...
    public Spike(Context context){
        spike[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.mapa); //cambiar recursos
        spike[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.mapa);
        spike[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.mapa);
        random = new Random();
        resetPosition();
    }
